 ...
 */
public class Int2DoubleNodePlugin extends Plugin {
    // The shared instance.
    private static Int2DoubleNodePlugin plugin;

    /**
     * The constructor.
     */
    public Int2DoubleNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static Int2DoubleNodePlugin getDefault() {
        return plugin;
    }
